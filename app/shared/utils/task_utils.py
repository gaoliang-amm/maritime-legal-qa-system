...
_NODE_NAME_TO_CN: Dict[str, str] = {
    "upload_file": "开始上传文件",
    "node_entry": "检查文件类型",
    "node_pdf_to_md": "PDF解析为Markdown",
    "node_md_img": "处理文档图片",
    "node_item_name_recognition": "识别法律法规名称",
    "node_document_split": "文档智能切分",
    "node_bge_embedding": "生成向量表示",
    "node_import_kg": "导入知识图谱",
    "node_import_milvus": "写入向量数据库",
    "__end__": "处理完成",
    "END": "处理完成",
    # --- Query 流程节点（kb/process/query/main_graph.py）---
    "node_item_name_confirm": "识别法律法规",
    "node_answer_output": "生成法律解答",
    "node_rerank": "相关性重排序",
    "node_rrf": "多路结果融合",
    "node_web_search_mcp": "联网搜索补充",
